...
## 2021년 1월 5일 수요일
출퇴근하는 동료들의 옷에 붙은 앵두 털을 제거하기 위해서 종이 테이프 방식의 롤 클리너를 비치해두었었는데, 그 소모량이 생각했던 것보다 컸다. 며칠 동안 쇼핑몰을 뒤지다가 씻어서 쓰는 롤 클리너를 발견하고 주문했다. 점착력이 강하다고는 하지만 이물질이 붙는 순간 빠르게 약해지지 않을지? 4개를 사서 돌려쓴다는 고양이 반려인의 리뷰도 있었다. 우선 하나만 사서 쓸모를 판단해보기로 한다.
